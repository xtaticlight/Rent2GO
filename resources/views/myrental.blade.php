        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/search_results') }}">
                    ...
                    <a data-toggle="tool-tip" Title = "Add Item" href="./add_item" role="button" class=" btn btn-success btn-lg pull-right"  > <span class="glyphicon glyphicon-plus"></span> </a>
                </form>
            </div>
            <label style="font-size: larger;font-weight: bold;margin-bottom: 30px;"> Properties Available :</label>
            <div class="row">
                @if($materials=='')
                    <br><br>
                    <alert class="warning">
                        <label for="" class="label label-default" style="font-size: medium;">No Available properties for
                            rent :D</label>
                    </alert>
                @else
